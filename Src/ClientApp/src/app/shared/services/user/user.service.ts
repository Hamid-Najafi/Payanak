...
export class UserService {
  ...
  editUser(userModel: UserModel) {
    return this.http.put<any>(API_BASE_USER + 'api/User', userModel);
  }
  ...
  editUserRole(roles: number[], userId: number) {
    ...
    return this.http.put<any>(API_BASE_USER + 'api/UserRoles', userModel);
  }
  ...
  editUserCredit(credit: CreditModel, userId: number) {
    return this.http.put<any>(API_BASE_USER + 'api/AdminUserCredit/' + userId, credit);
  }
